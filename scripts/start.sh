...
SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_KAKAO_CLIENT-ID=${SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_KAKAO_CLIENT}
SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_KAKAO_CLIENT-SECRET=${SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_KAKAO_CLIENT}
CUSTOM_GOOGLE_AI_GEMINI_PROJECT-ID=${CUSTOM_GOOGLE_AI_GEMINI_PROJECT}
CUSTOM_FINTECH_APIKEY=${CUSTOM_FINTECH_APIKEY}
EOF
